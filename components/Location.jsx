...
const locationCategories = [
  {
    ...
    items: [
      ...
      { name: 'Bandra Sealink', dist: '5 Mins' },
      { name: 'Lower Parel', dist: '15 Mins' },
      { name: 'Airport', dist: '20 Mins' },
    ],
  },
  {
    category: '5 Star Hotels',
    items: [
      { name: 'ITC Grand Central', dist: '18 Mins' },
      { name: 'Four Seasons', dist: '19 Mins' },
      { name: 'The St. Regis', dist: '19 Mins' },
      { name: 'The Taj Mahal Palace', dist: '43 Mins' },
    ],
  },
  {
    category: 'Railway Stations',
    items: [
      { name: 'Mahim Junction Station', dist: '1 Min' },
      { name: 'Dadar Station', dist: '10 Mins' },
      { name: 'Bandra Station', dist: '8 Mins' },
      { name: 'Upcoming Bullet Train Station', dist: '12 Mins' },
    ],
  },
  {
    category: 'Hospitals',
    items: [
      { name: 'Fortis SL Raheja Hospital', dist: '1 Min' },
      { name: 'Lilavati Hospital', dist: '5 Mins' },
      { name: 'Hinduja Hospital', dist: '3 Mins' },
      { name: 'Asian Heart Hospital', dist: '10 Mins' },
    ],
  },
  {
    category: 'Schools and Colleges',
    items: [
      { name: 'Bombay Scottish School', dist: '5 Mins' },
      { name: 'Stellar International', dist: '15 Mins' },
      { name: 'Arya Vidya Mandir', dist: '10 Mins' },
    ],
  },
]
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6211.717784768196!2d72.858954!3d19.184461!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b7006ca8c67d%3A0x9d05f173df0a247c!2sL%26T%20Luxury%20Project%20(Malad)!5e1!3m2!1sen!2sin!4v1781154797109!5m2!1sen!2sin"
                width="100%"
                height="100%"
