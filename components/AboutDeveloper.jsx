          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
                This Developer stands as one of India's premier real estate developers, boasting a collection of commercial and residential undertakings spread across Mumbai, Navi Mumbai, Bangalore, and Chennai. The residential division, armed with seasoned architects and consultants from India and abroad, diligently crafts architectural marvels that mirror their unwavering commitment to excellence and flawlessness. Whether considering their forthcoming residential schemes in Mumbai and beyond, or their accomplished projects spanning various years, all their creations endure the trials of time, metamorphosing into ageless architectural masterpieces and valuable legacies for generations to come to relish..
              </p>
            </div>
